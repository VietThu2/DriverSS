...
namespace ScanAndScale.Helper
{
    ...
    {
        public static string EncryptString(string Message, string Passphrase = "ITFramasBDVN")
        {
            byte[] Results;
        ...
        public static string DecryptString(string Message, string Passphrase = "ITFramasBDVN")
        {
            try
            {
                byte[] Results;
